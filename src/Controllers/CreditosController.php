...
class CreditosController extends Controller
{
    ...
    public function nuevo(): void
    {
        ...
        $this->view('vendedor/credito_form', compact('cliente', 'clientes', 'sucursales'));
    }
    ...
    public function store(): void
    {
        ...
        $cantCuotas   = (int) Request::post('cantidad_cuotas');
        $valorCuota   = (float) Request::post('valor_cuota');
        $montoDevolver = $cantCuotas * $valorCuota;
        ...
        $payload = [
            ...
            'monto_a_devolver'       => $montoDevolver ?: Request::post('monto_a_devolver'),
