                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex items-center justify-end gap-2">
                                <form method="POST"
                                    ...
                                    <?= csrf_field() ?>
                                    <button type="submit" title="<?= $u['activo'] ? 'Desactivar' : 'Activar' ?>"
                                            class="w-8 h-8 rounded-full flex items-center justify-center transition-colors <?= $u['activo'] ? 'bg-slate-50 text-slate-400 hover:bg-red-50 hover:text-red-600' : 'bg-slate-50 text-slate-400 hover:bg-emerald-50 hover:text-emerald-600' ?>">
                                        <i class="isax <?= $u['activo'] ? 'isax-minus-cirlce' : 'isax-play-circle' ?>"></i>
                                    </button>
                                </form>
